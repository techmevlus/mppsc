    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">MPPSC</li>
              <li data-filter=".filter-web">SSC</li>
              <li data-filter=".filter-vyapam">VYAPAM</li>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-vyapam">
            <div class="portfolio-wrap">
