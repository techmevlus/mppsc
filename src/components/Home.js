      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <h3>Learn how MEVLUS can make the way to Your success more guarnteed .</h3>
            <p class="fst-italic">
